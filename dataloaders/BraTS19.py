...
class BraTS2019(Dataset):
    """ BraTS2019-vnet Dataset """

    def __init__(self, split='train', num=None, transform=None):
        self._base_dir = '/home/kevin/PycharmProjects/Project-1/data_lists/BraTS2019'
        self.transform = transform
        self.sample_list = []
        self.data_path = '/home/kevin/PhD-datasets/BraTS19'
    ...
    def __getitem__(self, idx):
        ...
        h5f = h5py.File(self.data_path + "/{}.h5".format(image_name), 'r')
        image = h5f['image'][:]
        label = h5f['label'][:]
